...
public class InsertData {
    ...
    public InsertData() {
        ...
        try {
            ...
            // Updated URL with 127.0.0.1 and security flags
            String url = "jdbc:mysql://127.0.0.1:3306/databasedb?allowPublicKeyRetrieval=true&useSSL=false";

            // Passing credentials as separate arguments for reliability
            con = DriverManager.getConnection(url, "student1", "pass");

            stmt = con.createStatement();
        } catch (Exception e) {
            // Improved error reporting so you can see why a connection fails
            e.printStackTrace();
        ...
        try {
            ...
            // Inserting the rest of the crew
            System.out.println(
            ...
            // Manual commit to finalize the transaction
